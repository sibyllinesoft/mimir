...
class AlertManager:
    ...
    def _resolve_alert(self, rule_name: str, current_time: Optional[datetime] = None):
    ...
    def _send_notifications(self, alert: Alert):
        ...
        for handler in self.notification_handlers:
            try:
                ...
                logger.error(f"Error sending alert notification", error=str(e))
    ...
    def force_evaluation(self, rule_name: Optional[str] = None):
