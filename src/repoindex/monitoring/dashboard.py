...
class DashboardGenerator:
    ...
    def generate_pipeline_dashboard(self) -> Dashboard:
        ...
        active_pipelines_panel = Panel(
            ...
            panel_type="stat",
            targets=[
                self._create_target("mimir_pipeline_active_count", "Active")
            ],
        ...
        queue_panel = Panel(
            ...
            panel_type="stat", 
            targets=[
                self._create_target("mimir_pipeline_queue_length", "Queued")
            ],
        ...
        error_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'rate(mimir_pipeline_errors_total{stage!=""}[5m])',
                    "{{stage}} - {{error_type}}"
                )
            ],
    ...
    def generate_performance_dashboard(self) -> Dashboard:
        ...
        search_rate_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'rate(mimir_search_requests_total[5m])',
                    "{{search_type}} - {{status}}"
                )
            ],
        ...
        memory_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'mimir_memory_usage_bytes{type="rss"} / 1024 / 1024',
                    "RSS Memory (MB)"
                ),
                self._create_target(
                    'mimir_memory_usage_bytes{type="vms"} / 1024 / 1024',
                    "Virtual Memory (MB)"
                )
            ],
        ...
        cpu_panel = Panel(
            ...
            panel_type="graph",
            targets=[
                self._create_target("mimir_cpu_usage_percent", "CPU %")
            ],
        ...
        similarity_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'increase(mimir_vector_similarity_scores_bucket[5m])',
                    "{{le}}"
                )
            ],
    ...
    def generate_error_dashboard(self) -> Dashboard:
        ...
        health_panel = Panel(
            ...
            panel_type="stat",
            targets=[
                self._create_target("mimir_health_check_status", "{{check_type}}")
            ],
        ...
        uptime_panel = Panel(
            ...
            panel_type="stat",
            targets=[
                self._create_target("mimir_uptime_seconds / 3600", "Hours")
            ],
        ...
        error_breakdown_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'rate(mimir_pipeline_errors_total[5m])',
                ...
                self._create_target(
                    'rate(mimir_mcp_requests_total{status="error"}[5m])',
                    "MCP - {{method}}"
                )
            ],
            grid_pos=self._create_grid_pos(0, 4, 12, 8),
        ...
        severity_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'sum by(severity) (rate(mimir_pipeline_errors_total[5m]))',
                    "{{severity}}"
                )
            ],
            grid_pos=self._create_grid_pos(0, 12, 6, 8),
        ...
        mcp_panel = Panel(
            ...
            panel_type="graph",
            targets=[
                self._create_target("mimir_mcp_active_connections", "Active Connections")
            ],
            grid_pos=self._create_grid_pos(6, 12, 6, 8),
            id=self._next_panel_id(),
            field_config={
        ...
        fd_panel = Panel(
            ...
            panel_type="graph",
            targets=[
                self._create_target("mimir_file_descriptors_open", "Open FDs")
            ],
    ...
    def generate_business_dashboard(self) -> Dashboard:
        ...
        repos_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'increase(mimir_repositories_indexed_total{status="success"}[24h])',
                    "Last 24h"
                )
            ],
        ...
        symbols_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'increase(mimir_code_symbols_extracted_total[24h])',
                    "Last 24h"
                )
            ],
        ...
        embeddings_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'increase(mimir_vector_embeddings_created_total[24h])',
                    "Last 24h"
                )
            ],
            grid_pos=self._create_grid_pos(6, 0, 3, 4),
        ...
        queries_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'increase(mimir_research_queries_total{success="true"}[24h])',
                    "Last 24h"
                )
            ],
            grid_pos=self._create_grid_pos(9, 0, 3, 4),
        ...
        symbol_types_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'rate(mimir_code_symbols_extracted_total[5m])',
        ...
        complexity_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'rate(mimir_research_queries_total[5m])',
                    "{{complexity}} - {{success}}"
                )
            ],
            grid_pos=self._create_grid_pos(0, 12, 6, 8),
        ...
        results_panel = Panel(
            ...
            targets=[
                self._create_target(
                    'increase(mimir_search_results_count_bucket[5m])',
                    "{{le}}"
                )
            ],
            grid_pos=self._create_grid_pos(6, 12, 6, 8),
...
def generate_pipeline_dashboard(output_path: Optional[Path] = None) -> Dashboard:
...
def generate_performance_dashboard(output_path: Optional[Path] = None) -> Dashboard:
...
def generate_error_dashboard(output_path: Optional[Path] = None) -> Dashboard:
