...
try:
    ...
    class DummyTracer:
        def start_span(self, name, **kwargs): return DummySpan()
        def start_as_current_span(self, name, **kwargs): return contextmanager(lambda: iter([DummySpan()]))()
...
_current_trace_context: ContextVar[Optional[Dict[str, Any]]] = ContextVar('trace_context', default=None)
...
class TraceManager:
    ...
    @asynccontextmanager
    async def trace_search_request(
        self,
        search_type: str,
        query: str,
        **attributes
