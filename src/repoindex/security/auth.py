...
from ..util.errors import SecurityError, AuthenticationError
...
class RateLimiter:
    ...
    def check_rate_limit(
        ...
        return {
            ...
            "key_remaining": self.key_limits.get(api_key.key_id).remaining_requests() if api_key and api_key.key_id in self.key_limits else None,
    ...
    def _track_suspicious_behavior(self, client_ip: str, reason: str) -> None:
        ...
        now = time.time()
        suspicious_window = 600  # 10 minutes
