...
"""
    ...
    def create_mock_repomapper_output(self, files: list[str]) -> dict[str, Any]:
        ...
        return {
            "file_ranks": [
                ...
                {"path": "src/utils/jwt.ts", "rank": 0.65, "centrality": 0.5, "dependencies": []},
                {
    ...
    async def test_full_pipeline_with_mocked_tools(
        self, test_repo: Path, indexing_pipeline: IndexingPipeline
    ):
        ...
        print("Testing pipeline with mocked tools")
    ...
    @pytest.mark.integration
    async def test_search_with_mocked_data(
        self, test_repo: Path, indexing_pipeline: IndexingPipeline
    ):
    ...
    @pytest.mark.integration
    async def test_ask_functionality_with_mocked_data(
        self, test_repo: Path, indexing_pipeline: IndexingPipeline
    ):
    ...
    @pytest.mark.integration
    async def test_bundle_export_with_mocked_data(
        self, test_repo: Path, indexing_pipeline: IndexingPipeline
    ):
